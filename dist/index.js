...
define("@scom/scom-invoice/index.css.ts", ["require", "exports", "@ijstech/components"], function (require, exports, components_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.tableStyle = exports.imageStyle = exports.formStyle = void 0;
...
define("@scom/scom-invoice/payment.tsx", ["require", "exports", "@ijstech/components", "@scom/scom-invoice/assets.ts"], function (require, exports, components_4, assets_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ScomInvoicePayment = void 0;
    const Theme = components_4.Styles.Theme.ThemeVars;
    let ScomInvoicePayment = class ScomInvoicePayment extends components_4.Module {
        setData(data) {
            const { currency, total, url } = data;
            this.data = data;
            this.lblLink.caption = url || "";
            this.lblTotalPrice.caption = `$${components_4.FormatUtils.formatNumber(total, { decimalFigures: 2 })} ${currency}`;
        }
        copyUrl() {
            components_4.application.copyToClipboard(this.data.url || "");
        ...
        render() {
            return (this.$render("i-vstack", { maxWidth: "28.125rem", margin: { left: 'auto', right: 'auto' }, border: { width: 1, style: 'solid', color: Theme.divider, radius: '0.75rem' }, horizontalAlignment: "center" },
                ...
                this.$render("i-panel", { maxWidth: "20rem", minWidth: "20rem", maxHeight: "20rem", minHeight: "20rem", margin: { top: '2.5rem', bottom: '2.5rem', left: 'auto', right: 'auto' }, padding: { top: '1rem', bottom: '1rem', left: '1rem', right: '1rem' }, border: { width: '0.5rem', style: 'solid', color: Theme.colors.secondary.main, radius: '1rem' } },
                    this.$render("i-image", { display: "block", width: "100%", height: "100%", url: assets_1.default.fullPath('img/payment.png') })),
    ...
    ScomInvoicePayment = __decorate([
        (0, components_4.customElements)('i-scom-invoice-payment')
    ], ScomInvoicePayment);
    exports.ScomInvoicePayment = ScomInvoicePayment;
});
define("@scom/scom-invoice", ["require", "exports", "@ijstech/components", "@scom/scom-invoice/interface.ts", "@scom/scom-invoice/index.css.ts", "@scom/scom-invoice/assets.ts"], function (require, exports, components_5, interface_1, index_css_2, assets_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const Theme = components_5.Styles.Theme.ThemeVars;
    let ScomInvoice = class ScomInvoice extends components_5.Module {
        constructor() {
            super(...arguments);
            this.itemColumns = [
                {
                ...
                },
                {
                    ...
                    onRenderCell: (source, columnData, rowData) => {
                        return (this.$render("i-label", { caption: `$${components_5.FormatUtils.formatNumber(columnData, { decimalFigures: 2 })}` }));
                    }
                },
                {
                    title: 'AMOUNT',
                    ...
                    onRenderCell: (source, columnData, rowData) => {
                        ...
                        return (this.$render("i-label", { caption: `$${components_5.FormatUtils.formatNumber(amount, { decimalFigures: 2 })}` }));
                    }
                }
            ];
        ...
        viewInvoice(data) {
            ...
            this.imgAvatar.url = this._billFrom?.avatar || assets_2.default.fullPath('img/default_avatar.png');
            this.lblUserName.caption = this._billFrom?.username || "";
            this.lblInternetIdentifier.caption = this._billFrom?.internetIdentifier || "";
            this.lblUserPubKey.caption = this._billFrom?.npub ? components_5.FormatUtils.truncateWalletAddress(this._billFrom?.npub) : "";
            this.lblInvoiceNumber.caption = "INVOICE #" + data.billNumber;
            this.lblBilledTo.caption = data.billTo;
            this.lblDueDate.caption = components_5.moment.unix(data.dueDate).format('MMM DD, YYYY');
            const status = data.status ?? interface_1.Status.Unpaid;
            ...
            this.lblTotal.caption = `$${components_5.FormatUtils.formatNumber(data.total, { decimalFigures: 2 })} ${data.currency}`;
        ...
        render() {
            return (this.$render("i-panel", { width: "100%", height: "100%" },
                this.$render("i-scom-invoice-form", { id: "invoiceForm", onSendBill: this.handleSendBill }),
                this.$render("i-vstack", { id: "pnlInvoice", gap: "1.5rem", visible: false },
                            ...
                            this.$render("i-hstack", { minWidth: 0, verticalAlignment: "center", stack: { grow: "1", shrink: "1" } },
                                this.$render("i-panel", { width: "3rem", height: "3rem", stack: { shrink: '0' }, margin: { right: "0.75rem" }, border: { radius: "50%" }, overflow: "hidden" },
                                    this.$render("i-panel", { width: "100%", height: 0, overflow: "hidden", padding: { bottom: "100%" } },
                                        this.$render("i-image", { id: "imgAvatar", class: index_css_2.imageStyle, position: "absolute", display: "block", width: "100%", height: "100%", top: "100%", left: 0, url: assets_2.default.fullPath('img/default_avatar.png') }))),
                    ...
                    this.$render("i-hstack", { id: "pnlButtons", horizontalAlignment: "end", visible: false },
                        this.$render("i-button", { caption: "Pay Invoice", border: { radius: '0.5rem' }, boxShadow: 'none', padding: { top: '0.625rem', bottom: '0.625rem', left: '1.25rem', right: '1.25rem' }, font: { weight: 600 }, onClick: this.payInvoice }))),
                this.$render("i-scom-invoice-payment", { id: "invoicePayment", visible: false })));
        }
    };
    ScomInvoice = __decorate([
        (0, components_5.customElements)('i-scom-invoice')
    ], ScomInvoice);
